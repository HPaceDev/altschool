 ...
 * Карта покрытия.
 *
 * Заказчик ответил на Q-025: карта нужна, но в промежуточном виде, чтобы не
 * усложнять проект. Это ровно то, что здесь и сделано: схема показывает то,
 * ради чего карта нужна, — где густо, где пусто и что из этого проверено, —
 * не требуя платного картографического сервиса и координат у каждой школы.
 * Схематичность подписана прямо на экране, чтобы её не приняли за готовую карту.
 */
    ...
    <>
      ...
      <div className="mt-4 rounded-2xl border border-warm-line bg-warm-soft px-5 py-4">
        <p className="text-sm leading-relaxed text-warm">
          Это схема, а не карта: точки расставлены условно. Так и договорились —
          карта нужна, но в промежуточном виде, чтобы не усложнять проект (
          <Link href="/questions/Q-025" className="font-medium underline underline-offset-2">
            Q-025
          </Link>
          ). Настоящий картографический сервис и координаты у каждой школы — следующий
          шаг, уже в разработке.
        </p>
      </div>
