...
export const metadata: Metadata = {
  title: {
    default: "Карта школ РО — прототип",
    template: "%s — Карта школ РО",
  },
  description:
    "Кликабельный прототип проверяемой карты школ развивающего обучения и вопросы к заказчику на этапе проектирования.",
